...
var budgetController = (function() {
	...
	//Adding new elements to the arrays and assigning IDs to each new item
	return {
...
var UIController = (function() {
	...
	//Formatting the strings of numbers
	...
	return {
		...
		addListItem: function(obj, type) {
			...
			// Create HTML screen wuth placeholder text
...
var controller = (function(budgetCtrl, UICtrl) {
	...
	var updatePercentages = function() {
		...
		// 3. Display percentage next to exp input
	...
	var ctrlDeleteItem = function(event) {
		...
		if (itemID) {
			...
			//3. Update and show new budget calc
	...
	function addInput() {
		...
		if(input !== '') {
			...
			notesArray.push(newLi);
			
			document.getElementById('user-input').value = '';
			
			var idNum = `closeout` + notesArray.length;
